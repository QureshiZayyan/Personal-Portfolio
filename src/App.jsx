    ...
    <>
      ...
      <main>
        ...
        <section className="project mt-0 mx-[40px] mb-[150px]">
          ...
          <div className="cards-container grid lg:grid-cols-5 md:grid-cols-2 my-[50px] place-items-center md:gap-y-11 md:mx-[19vw] xl:mx-24 lg:mx-[8vw]">
            <Cards name="News App" imageurl={image2} link='https://github.com/QureshiZayyan/News-App-React' about='React,Tailwind' />
