...
export const Header = (props) => {
    ...
    return (
        <>
            <header>
                <div className="intro flex items-center mt-[50px] mr-[80px] ml-[60px]">
                    <div className="left w-[49%] md:w-[300px] bg-red-600 md:h-[120px]">
                    ...
                    <div className="right w-[50%] lg:mr-[-180px] md:mr-[-220px]">
                        <img src={props.imageurl} alt="" className="img w-[63%]" />
                    </div>
                </div>

                <div className="resume-github mx-[60px] relative lg:-top-11 md:top-20">
