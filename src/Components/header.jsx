  ...
  return (
    <>
      ...
      <div className="resume-github mx-[65px] relative lg:-top-8 md:top-3 xl:-top-16">
        <a href='src/assets/Zayyan Resume.pdf' target="_blank" className="text" download><button className="btn text-[13px] px-[6.3px] py-[4px] font-[765] shadow-bs hover:outline-none hover:opacity-[0.8] hover:transform hover:translate-y-[-2px] duration-300 cursor-pointer rounded-[5px] bg-white">Download Resume</button></a>
