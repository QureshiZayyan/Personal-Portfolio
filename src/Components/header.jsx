  ...
  return (
    <>
      ...
      <div className="resume-github mx-[65px] relative lg:-top-8 md:top-3 xl:-top-16">
        <a href="src/assets/Resume.pdf" target="_blank" className="text" download><button className="btn text-[13px] px-[6.3px] py-[4px] font-[765] cursor-pointer rounded-[5px] bg-white hover:translate-y-[-2px] hover:opacity-[0.6] duration-300">Download Resume</button></a>
        <a href="https://github.com/QureshiZayyan" target='_blank' className="text"><button id="btn" className="btn text-[13px] px-[6.3px] py-[4px] font-[765] cursor-pointer rounded-[5px] bg-white ml-[11px] hover:translate-y-[-2px] hover:opacity-[0.6] duration-300">Visit Github</button></a>
      </div>
    </>
  )
}
