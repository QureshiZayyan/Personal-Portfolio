...
export const BlogCard = ({ name, about, imageurl, link }) => {
    return (
        <>
            {/* <Router> */}
            {/* <Routes> */}
            <div className="blog-card bg-white xl:w-[13.8vw] lg:w-[21vw] md:w-[24vw] rounded-lg">
                <a href={link} target='_blank'>
                    <div className="image p-[8px]">
                        <img className="w-full rounded-[8px] bg-black aspect-video" src={vscode} alt={name} />
                    </div>
                    <div className="project-content px-[8px] pt-1 pb-4">
                        <h3 className="font-semibold h-9 leading-6 mb-[7px] text-lg xl:text-lg">{name}</h3>
                        <p className="about-project mt-7 mb-[7px] xl:text-[16.8px] lg:text-[14px]">{about}</p>
                        <Link to='/blogpage'><button className="button mt-4">
