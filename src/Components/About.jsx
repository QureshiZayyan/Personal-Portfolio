...
export const About = () => {
    return (
        <>
            <section className="about shadow-bs leading-6 text-white flex items-center lg:flex-row md:justify-center md:flex-col text-base pt-[32px] lg:pr-[9px] lg:pb-[23px] lg:pl-[80px] my-[93px] md:pl-[10px] md:pr-[40px] md:pb-[17px]">
